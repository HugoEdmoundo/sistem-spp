    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body p-0">
            ...
            <div class="text-center py-5">
                ...
                <p class="text-muted">Semua tagihan sudah lunas atau belum ada tagihan.</p>
            </div>
            @endif
        </div>
    </div>
...
function updateSisaInfo{{ $item->id }}(jumlah) {
    ...
    if (jumlahNum > 0) {
        ...
        document.getElementById('sisaAmount{{ $item->id }}').textContent = 'Rp ' + sisaSetelahBayar.toLocaleString('id-ID');
    } else {
