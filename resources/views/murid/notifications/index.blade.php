<!-- resources/views/murid/notifications/index.blade.php -->
@extends('layouts.app')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4>Notifikasi</h4>
    <div>
        <form action="{{ route('murid.notifications.read-all') }}" method="POST" class="d-inline">
            @csrf
            ...
            <div class="list-group list-group-flush">
                ...
                <div class="list-group-item {{ is_null($notification->read_at) ? 'bg-light' : '' }}">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <form action="{{ route('murid.notifications.read', $notification->id) }}" method="POST" class="d-inline">
                            @csrf
