    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.pengeluaran.update', $pengeluaran->id) }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="kategori" class="form-control" id="kategoriSelect" required>
                        @foreach($kategori as $kat)
                            <option value="{{ $kat }}" {{ $pengeluaran->kategori == $kat ? 'selected' : '' }}>
                                {{ $kat }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="mb-3" id="customKeterangan" style="display: none;">
                ...
                <input type="text" name="keterangan_custom" class="form-control" placeholder="Masukkan keterangan pengeluaran">
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="jumlah" class="form-control" value="{{ $pengeluaran->jumlah }}" min="0" required>
                </div>
            </div>
